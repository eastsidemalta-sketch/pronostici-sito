  ...
  apps: [
    {
      ...
      script: "node",
      args: "server.js",
      env: { PORT: 3001, HOSTNAME: "0.0.0.0", CRON_SECRET: "VURWDkW6Jw", LIVE_API_MONTHLY_BUDGET: "4500000" },
    },
    {
      name: "pronostici",
      ...
      interpreter: "bash",
      env: { PORT: "3000", HOSTNAME: "0.0.0.0", CRON_SECRET: "VURWDkW6Jw", LIVE_API_MONTHLY_BUDGET: "4500000" },
    },
  ],
};
